    ...
    <div className="col-lg-3 col-md-4 col-sm-6 col-xsm-6">
      <div className="product-item text-center">
        <div className="product-item__thumb">
          ...
          <button className="product-item__icon" onClick={handleWishlistToggle}>
        ...
        <div className="product-item__content">
          ...
          <ul className="product-info__rating justify-content-center align-items-center">
            ...
            <li className="product-info__number">{product.rating}4.5</li>
          </ul>
